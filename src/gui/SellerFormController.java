...
public class SellerFormController implements Initializable {
	...
	@FXML
	private ComboBox<Department> comboBoxDepartment; //ComboBox cujos objetos sao do tipo Department e de nome comboBoxDepartment
	...
	public void updateFormData() {
		...
		if (entity.getDepartment() == null) { //se o departamento do vendedor(entity) for null (cadastrando vendedor novo)
			comboBoxDepartment.getSelectionModel().selectFirst();
		}
		else {
			comboBoxDepartment.setValue(entity.getDepartment()); //o departamento associado ao vendedor(entity) vai para o comboBox (se o departamento nao for nulo)
		}		
	}
